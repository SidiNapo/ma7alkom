          ...
          >
            ...
            <div className="mt-4 lg:mt-0 flex justify-center lg:block lg:absolute lg:-bottom-3 lg:-right-3">
              <motion.div
                ...
                className="inline-flex items-center gap-1.5 sm:gap-2 bg-gradient-to-r from-primary to-accent text-primary-foreground px-3 py-1.5 sm:px-4 sm:py-2 rounded-full shadow-lg"
              >
...
export default ProductPageAnimated;
